...
const NavBar = () => {
  ...
  return (
    <header className="flex justify-between py-8 px-4 text-2xl text-white items-center bg-[#1A0B2E] relative md:py-0 z-50">
      <h1 className="font-semibold">Cristian.G</h1>
      <i onClick={handleShowNav} className="bx bx-menu text-3xl cursor-pointer md:hidden"></i>

      <nav className={`absolute top-full ${isShowNav ? "left-0" : "-left-full"} w-full grid text-lg bg-indigo-950 duration-200 md:static md:flex md:w-auto md:gap-2 md:bg-inherit md:text-center md:items-center`}>
